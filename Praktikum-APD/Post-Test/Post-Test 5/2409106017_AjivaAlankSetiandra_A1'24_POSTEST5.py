...
while True:
    ...
    if choose == 1:
        ...
        print()
        Character_info.append ([nama,age,gender,mbti])
#system pembacaan character
    elif choose == 2:
        for i in range(len(Character_info)):
            print(f"\n Character {i+1}\nName : {Character_info[i][0]}\nAge : {Character_info[i][1]}\nGender : {Character_info[i][2]} \nMbti : {Character_info[i][3]}")
#system update character
    elif choose == 3:
        prev_name = input("Which character you'd to change? : ")
        for i in range(len(Character_info)):
            if Character_info[i][0] == prev_name:
                ...
                Character_info[i][0] = new_name
                Character_info[i][1] = new_age
                Character_info[i][2] = new_gender
                Character_info[i][3] = new_mbti
#system penghapusan character
    elif choose == 4:
        old_name = input("Which character that you want to delete? : ")
        for i in range(len(Character_info)):
            if Character_info[i][0] == old_name:
                del Character_info[i]
